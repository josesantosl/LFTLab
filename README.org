...
chiamata _tag_ per riconoscere quale token è ognuno. La clase [[file:Token.java][Token]] ha un'insieme di
...
La classe [[file:Word.java][Word.java]] viene come estensione di Token. Se per Token solo usavamo un unico
...
tempo. Per queste parole dovremo chiedere alla classe [[file:Tag.java][Tag.java]] che contiene tutti i
...
di poter salvare il numero come un valore intero e no una 

* Lexer
* SymbolTable
* CodeGenerator & Instruction
* Translator
[[file:Translator.java][Translator]] è una espansione del [[file:/../Esercizio3/Parser32.java][Parser]] dell'esercizio 3

* TODO list for this weekend to complete this project
** WORKING complete the label shares <2023-08-25>
** WORKING add all the emitCode      <2023-08-26>
** TODO set correct label list       <2023-09-01>
** TODO Write the documentation for all the files. <2023-09-04>
